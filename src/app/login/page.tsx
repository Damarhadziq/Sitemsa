...
import { authenticateStudent } from '@/services/student-profile.service';
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (studentAuth.success) {
        ...
        setErrorMsg(studentAuth.message || 'Email atau kata sandi salah');
        setIsPending(false);
      }
    }, 250);
  };
    ...
    <div className="min-h-screen bg-white flex flex-col relative overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col lg:flex-row items-center px-6 lg:px-20 xl:px-28 pt-20 pb-8">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center lg:pr-16 xl:pr-24 mb-12 lg:mb-0">
          ...
          <p className="text-base text-gray-500 mb-14 max-w-md leading-relaxed">
        ...
        <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
          <div className="w-full max-w-[451px]">
            <form onSubmit={handleSubmit} className="flex flex-col">
              {errorMsg && (
                <div className="bg-red-50 text-red-600 p-3 rounded-[10px] text-sm font-medium border border-red-200 mb-6 animate-in fade-in">
                  {errorMsg}
                </div>
              )}
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-[10px]">
                  <label className="text-base font-medium text-[#292929]" htmlFor="email">
                    Email
                  </label>
                  <input
                    id="email"
                ...
                {/* Kata Sandi */}
                <div className="flex flex-col gap-[10px]">
                  <label className="text-base font-medium text-[#292929]" htmlFor="password">
                    Kata Sandi
                  </label>
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-[#292929] hover:text-gray-600 focus:outline-none cursor-pointer"
                    >
                      {showPassword ? <EyeOff size={19} /> : <Eye size={19} />}
                    </button>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <Link href="#" className="text-sm font-medium text-[#2563EB] hover:opacity-80 transition-opacity">
                      Lupa kata sandi?
                    </Link>
                    <Link href="/admin/login" className="text-xs font-medium text-slate-500 hover:text-[#2563EB] transition-colors">
                      Portal Guru ➔
                    </Link>
                  </div>
                </div>
              ...
              <div className="flex flex-col mt-6">
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className="w-full h-[47px] bg-[#2563EB] hover:bg-[#1D4ED8] active:scale-[0.99] text-white font-semibold rounded-[10px] transition-all disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center text-base cursor-pointer shadow-sm"
                >
                ...
                <div className="relative flex items-center py-3">
                  ...
                  <span className="flex-shrink-0 px-4 text-base text-[#334155]">atau</span>
                  <div className="flex-grow border-t border-gray-200"></div>
                </div>
                ...
                <button
                  type="button"
                  onClick={() => {
                    // Google SSO Placeholder action
                    const studentAuth = authenticateStudent('siswa@belajar.id', 'SiswaSitemsa#2026');
                    if (studentAuth.success) router.push('/');
                  }}
                  className="w-full h-[52px] bg-white border border-gray-200 text-[#2E2D2D] font-semibold rounded-[10px] hover:bg-gray-50 active:scale-[0.99] transition-all flex items-center justify-center gap-2.5 text-base cursor-pointer"
                >
      ...
      <footer className="flex items-center justify-between px-6 lg:px-20 xl:px-28 py-6">
        {/* Social icons - left */}
        <div className="flex items-center gap-5">
          ...
          <Link href="#" className="hover:opacity-60 transition-opacity">
            ...
            <svg width="24" height="24" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M18.6975 8.98725C20.4986 10.2789 22.7041 11.0389 25.0863 11.0389V7.41745C23.7566 7.1332 22.5794 6.43584 21.6943 5.46587C20.1793 4.51713 19.0878 2.95194 18.7678 1.12H15.4281V19.4958C15.4205 21.638 13.6882 23.3726 11.5519 23.3726C10.293 23.3726 9.1746 22.7704 8.46629 21.8375C7.20147 21.1968 6.3341 19.8816 6.3341 18.3627C6.3341 16.2145 8.06931 14.4728 10.2102 14.4728C10.6204 14.4728 11.0158 14.5369 11.3866 14.655V10.994C6.78908 11.0893 3.09155 14.8593 3.09155 19.4958C3.09155 21.8104 4.01232 23.9086 5.50674 25.4417C6.85492 26.3502 8.47787 26.88 10.224 26.88C14.9038 26.88 18.6976 23.0727 18.6976 18.3761V8.98725H18.6975Z" fill="#2E2D2D"/>
