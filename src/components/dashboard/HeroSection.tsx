export function HeroSection() {
  return (
    <section className="mb-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
      ...
      <div className="w-full md:w-[380px] bg-[#FAFAFA] border border-[#ECECEC] rounded-[12px] p-5 space-y-3 shrink-0 hover:border-[#0400F4]/30 transition-colors duration-300 ease-out">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex-1 h-2 bg-white border border-[#ECECEC] rounded-full overflow-hidden p-[1px]">
            <div className="h-full w-[60%] bg-[#0400F4] rounded-full transition-all duration-500 ease-out" />
          </div>
