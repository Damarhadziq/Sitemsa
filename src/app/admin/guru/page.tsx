                ...
                <div className="relative z-10 w-full h-full bg-gradient-to-br from-[#EFF6FF] via-[#F8FAFC] to-[#EFF6FF] rounded-[9px] p-6 flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-lg font-bold text-[#2E2D2D] leading-snug mb-2">
                      Analisis Kilat Pembelajaran
                    </h3>

                    <p className="text-xs text-[#737373] leading-relaxed mb-4">
                      Ketik perintah untuk menyusun ringkasan remedial, analisis kuis, atau ide modul {currentSubject}.
                    </p>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button
                        type="button"
                        className="px-3 py-1.5 rounded-[6px] text-xs font-semibold bg-[#2563EB] text-white hover:bg-blue-700 transition-colors cursor-pointer"
                      >
                        Analisis Nilai Kuis
                      </button>
                      <button
                        type="button"
                        className="px-3 py-1.5 rounded-[6px] text-xs font-medium bg-white text-[#2E2D2D] border border-[#ECECEC] hover:bg-slate-50 transition-colors cursor-pointer"
                      >
